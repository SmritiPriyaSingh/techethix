    ...
    <footer className="border-t border-slate-800/80 bg-slate-950/90 text-slate-400 relative z-10 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-slate-800/60">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-xs text-slate-400 max-w-md leading-relaxed">
              Personal website & cybersecurity journal. Documenting cybersecurity engineering projects, hands-on lab notes, and educational content.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link href="/journal" className="hover:text-cyan-400 transition-colors">
                  Journal
                </Link>
              </li>
              <li>
                <Link href="/lab-notes" className="hover:text-cyan-400 transition-colors">
                  Lab Notes
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-xs text-slate-400">
              ...
              <li className="flex items-center gap-1.5">
                ...
                <span>Network Defense & Security</span>
              </li>
              <li className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>
                <span>DFIR & Incident Response</span>
              </li>
              <li className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                <span>TechEthic Educational Content</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <p>© {new Date().getFullYear()} Smriti / TechEthic. B.Tech in CSE (Cybersecurity).</p>
          <div className="flex items-center gap-4 font-mono text-[11px]">
            <span>Clean & Minimal Portfolio</span>
          </div>
        </div>
      </div>
    </footer>
